...
import { changePassword, deleteSession, getMe, getPref, getSessions, putPrefrences, setGetMe } from "../../controllers/user-controller/user.controller.js";
...
userRouter.delete("/me/sessions/:session_id",refreshAuth,deleteSession)
